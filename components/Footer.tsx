        ...
        <div className="grid md:grid-cols-12 gap-y-14">
          ...
          <div className="md:col-span-4">
            <div className="flex items-center gap-x-3">
              <img src="/logo-white.png" alt="Western Jobs" className="h-10 w-auto" />
              <div>
            ...
            <div className="mt-8 flex gap-x-3">
              <a href="https://www.linkedin.com/company/western-jobs/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-x-2 px-4 py-2 border border-white/20 rounded-2xl hover:bg-white/5 hover:border-white/40 transition-all text-xs">
                <i className="fa-brands fa-linkedin-in text-[#0A66C2]"></i>
                <span className="text-white/60">Company</span>
              </a>
              <a href="https://www.linkedin.com/in/jey-singh-b5a630315/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-x-2 px-4 py-2 border border-white/20 rounded-2xl hover:bg-white/5 hover:border-white/40 transition-all text-xs">
                <i className="fa-brands fa-linkedin-in text-[#0A66C2]"></i>
          ...
          {/* Industries */}
          <div className="md:col-span-2">
            <div className="font-semibold text-white text-xs tracking-widest mb-4">INDUSTRIES</div>
            <div className="space-y-[13px]">
              <Link href="/manufacturing-staffing-ontario" className="block hover:text-white transition-colors">Manufacturing</Link>
              <Link href="/warehouse-staffing-ontario" className="block hover:text-white transition-colors">Warehousing</Link>
              <Link href="/automotive-staffing-ontario" className="block hover:text-white transition-colors">Automotive</Link>
              <Link href="/logistics-staffing-ontario" className="block hover:text-white transition-colors">Logistics</Link>
              <Link href="/administrative-staffing-ontario" className="block hover:text-white transition-colors">Administrative</Link>
              <Link href="/industries" className="block text-[#00C9A7] hover:text-white transition-colors">All Industries →</Link>
            </div>
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <div className="space-y-[13px]">
              ...
              <Link href="/automotive-staffing-ontario" className="block hover:text-white transition-colors">Auto Sector</Link>
            </div>
          </div>
