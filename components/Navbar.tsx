        ...
        <div className="max-w-screen-2xl mx-auto px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <Link href="/" className="flex items-center gap-x-3">
              <div className="w-11 h-11 bg-[#0A2540] rounded-2xl flex items-center justify-center">
                <span className="text-white font-bold text-2xl">WJ</span>
              </div>
              <div>
                <div className="font-bold text-2xl tracking-tight">Western Jobs</div>
                <div className="text-[10px] text-slate-500 -mt-1 tracking-[1px]">PREMIUM STAFFING</div>
              </div>
            </Link>
            ...
            <div className="hidden md:flex items-center gap-x-4">
              ...
              <div className="relative w-56">
                <input 
                  ...
                  className="w-full border border-slate-300 rounded-3xl pl-10 py-2 text-sm focus:outline-none focus:border-[#00C9A7]"
                />
                <span className="absolute left-4 top-2.5 text-slate-400">🔍</span>
              </div>

              {/* Phone - ONLY IN MAIN NAV */}
          ...
          {isOpen && (
            <div className="md:hidden py-6 border-t">
              <div className="flex flex-col gap-y-4 text-sm font-medium">
                ...
                <Link href="/employers" className="py-2">For Employers</Link>
                <Link href="/job-seekers" className="py-2">For Job Seekers</Link>
                <Link href="/industries" className="py-2">Industries</Link>
                <Link href="/how-we-work" className="py-2">How We Work</Link>
