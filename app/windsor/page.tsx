...
export default function WindsorPage() {
  ...
  dangerouslySetInnerHTML={{
    __html: JSON.stringify({
      ...
      "@type": "LocalBusiness",
      "name": "Western Jobs - Windsor Staffing Agency",
      "url": "https://www.westernjobs.ca/windsor",
      "telephone": "+1-226-697-7800",
      "email": "info@westernjobs.ca",
      "image": "https://www.westernjobs.ca/logo.png",
      "description": "Trusted staffing agency in Windsor, Ontario. Fast temporary, permanent, and contract staffing solutions. 48-hour average fill time.",
      "address": {
        "@type": "PostalAddress",
...
/>
      ...
      <section className="bg-[#0A2540] py-20 text-white">
        <div className="max-w-screen-2xl mx-auto px-8">
          <div className="max-w-4xl">
            <div className="text-xs font-bold tracking-[2px] text-[#00C9A7]">WINDSOR STAFFING</div>
            <h1 className="section-header mt-3 text-white">
              Premium Staffing Agency in Windsor
            </h1>
            <p className="mt-6 text-xl text-white/80 max-w-3xl">
              Western Jobs delivers fast and reliable temporary, permanent, and contract staffing solutions for businesses across Windsor and Southwestern Ontario.
            </p>
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              ...
              >
                Hire Staff in Windsor <i className="fa-solid fa-arrow-right"></i>
              </Link>
              <Link 
                href="/apply" 
      ...
      <section className="max-w-screen-2xl mx-auto px-8 py-20">
        <div className="grid lg:grid-cols-12 gap-x-16 gap-y-12 items-center">
          <div className="lg:col-span-6">
            <div className="text-xs font-bold tracking-[2px] text-emerald-600">WHY WINDSOR BUSINESSES CHOOSE WESTERN JOBS</div>
            <h2 className="section-header mt-3">Fast, reliable staffing support in Windsor</h2>
            <p className="mt-6 text-lg text-slate-600">
              Windsor has a strong manufacturing and automotive presence. We help employers quickly find production staff, warehouse workers, supervisors, and skilled trades across the city.
            </p>
          </div>
          ...
          <div className="lg:col-span-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[
                { title: "48-Hour Average Fill Time", desc: "We move fast to fill urgent roles in Windsor." },
                { title: "98.4% Retention Rate", desc: "Our placements stay because we focus on the right fit." },
                { title: "Strong Local Market Knowledge", desc: "We understand Windsor’s manufacturing and automotive needs." },
      ...
      <section className="bg-slate-50 py-20">
        <div className="max-w-screen-2xl mx-auto px-8">
          <div className="text-center mb-12">
            <div className="text-xs font-bold tracking-[2px] text-emerald-600">STAFFING SERVICES IN WINDSOR</div>
            <h2 className="section-header mt-3">Flexible solutions for Windsor employers</h2>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { title: "Temporary Staffing", desc: "Quick coverage for seasonal peaks, absences, and urgent needs in Windsor." },
              { title: "Permanent Placement", desc: "Strategic hiring for long-term roles in Windsor’s manufacturing market." },
              { title: "Temp-to-Perm", desc: "Evaluate candidates on the job before making permanent hires in Windsor." },
              { title: "Contract Staffing", desc: "Specialized talent for projects and fixed-term roles in Windsor." },
            ].map((service, index) => (
      ...
      <section className="bg-[#0A2540] py-20 text-white text-center">
        <div className="max-w-3xl mx-auto px-8">
          <h2 className="text-4xl font-bold tracking-tight">Need staff in Windsor?</h2>
