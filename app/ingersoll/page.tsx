...
alternates: {
    canonical: "https://www.westernjobs.ca/ingersoll",
  },
}
...
export default function IngersollPage() {
  ...
  dangerouslySetInnerHTML={{
    __html: JSON.stringify({
      ...
      "@type": "LocalBusiness",
      "name": "Western Jobs - Ingersoll Staffing Agency",
      "url": "https://www.westernjobs.ca/ingersoll",
      "telephone": "+1-226-697-7800",
      "email": "info@westernjobs.ca",
      "image": "https://www.westernjobs.ca/logo.png",
      "description": "Trusted staffing agency in Ingersoll, Ontario. Fast temporary, permanent, and contract staffing. Supplying labour to CAMI and automotive suppliers in Oxford County.",
      "address": {
        "@type": "PostalAddress",
      ...
      "areaServed": { "@type": "City", "name": "Ingersoll" },
